...
class ScanRequest final :
 ...
 public:
  ...
  enum : int {
    kKeyStartFieldNumber = 1,
    kKeyEndFieldNumber = 2,
  };
  // string key_start = 1;
  void clear_key_start();
  const std::string& key_start() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_key_start(ArgT0&& arg0, ArgT... args);
  std::string* mutable_key_start();
  PROTOBUF_NODISCARD std::string* release_key_start();
  void set_allocated_key_start(std::string* key_start);
  private:
  const std::string& _internal_key_start() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_key_start(const std::string& value);
  std::string* _internal_mutable_key_start();
  public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_key_end(ArgT0&& arg0, ArgT... args);
  std::string* mutable_key_end();
  PROTOBUF_NODISCARD std::string* release_key_end();
  void set_allocated_key_end(std::string* key_end);
  private:
  const std::string& _internal_key_end() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_key_end(const std::string& value);
  std::string* _internal_mutable_key_end();
  public:
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr key_start_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr key_end_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_kvstore_2eproto;
...
class ScanResponse final :
 ...
 public:
  ...
  public:
  void clear_entries();
  ::kvstore::KvEntry* mutable_entries(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::kvstore::KvEntry >*
      mutable_entries();
  private:
  const ::kvstore::KvEntry& _internal_entries(int index) const;
  ::kvstore::KvEntry* _internal_add_entries();
  public:
  const ::kvstore::KvEntry& entries(int index) const;
  ::kvstore::KvEntry* add_entries();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::kvstore::KvEntry >&
      entries() const;
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::kvstore::KvEntry > entries_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_kvstore_2eproto;
...
class KvEntry final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:kvstore.KvEntry) */ {
 public:
  inline KvEntry() : KvEntry(nullptr) {}
  ~KvEntry() override;
  explicit PROTOBUF_CONSTEXPR KvEntry(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  KvEntry* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  // @@protoc_insertion_point(class_scope:kvstore.KvEntry)
 private:
  class _Internal;
...
// string value = 2;
inline void SwapRequest::clear_value() {
  _impl_.value_.ClearToEmpty();
}
inline const std::string& SwapRequest::value() const {
  // @@protoc_insertion_point(field_get:kvstore.SwapRequest.value)
  return _internal_value();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SwapRequest::set_value(ArgT0&& arg0, ArgT... args) {
 
 _impl_.value_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:kvstore.SwapRequest.value)
}
inline std::string* SwapRequest::mutable_value() {
  std::string* _s = _internal_mutable_value();
  // @@protoc_insertion_point(field_mutable:kvstore.SwapRequest.value)
  return _s;
}
inline const std::string& SwapRequest::_internal_value() const {
  return _impl_.value_.Get();
}
inline void SwapRequest::_internal_set_value(const std::string& value) {
  
  _impl_.value_.Set(value, GetArenaForAllocation());
}
inline std::string* SwapRequest::_internal_mutable_value() {
  
  return _impl_.value_.Mutable(GetArenaForAllocation());
}
inline std::string* SwapRequest::release_value() {
  // @@protoc_insertion_point(field_release:kvstore.SwapRequest.value)
  return _impl_.value_.Release();
}
inline void SwapRequest::set_allocated_value(std::string* value) {
  if (value != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:kvstore.SwapRequest.value)
}
...
// bool found = 1;
inline void SwapResponse::clear_found() {
  _impl_.found_ = false;
}
inline bool SwapResponse::_internal_found() const {
  return _impl_.found_;
}
inline bool SwapResponse::found() const {
  // @@protoc_insertion_point(field_get:kvstore.SwapResponse.found)
  return _internal_found();
}
inline void SwapResponse::_internal_set_found(bool value) {
  
  _impl_.found_ = value;
}
inline void SwapResponse::set_found(bool value) {
  _internal_set_found(value);
  // @@protoc_insertion_point(field_set:kvstore.SwapResponse.found)
}
...
// string key_start = 1;
inline void ScanRequest::clear_key_start() {
  _impl_.key_start_.ClearToEmpty();
}
inline const std::string& ScanRequest::key_start() const {
  // @@protoc_insertion_point(field_get:kvstore.ScanRequest.key_start)
  return _internal_key_start();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ScanRequest::set_key_start(ArgT0&& arg0, ArgT... args) {
 
 _impl_.key_start_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:kvstore.ScanRequest.key_start)
}
inline std::string* ScanRequest::mutable_key_start() {
  std::string* _s = _internal_mutable_key_start();
  // @@protoc_insertion_point(field_mutable:kvstore.ScanRequest.key_start)
  return _s;
}
inline const std::string& ScanRequest::_internal_key_start() const {
  return _impl_.key_start_.Get();
}
inline void ScanRequest::_internal_set_key_start(const std::string& value) {
  
  _impl_.key_start_.Set(value, GetArenaForAllocation());
}
inline std::string* ScanRequest::_internal_mutable_key_start() {
  
  return _impl_.key_start_.Mutable(GetArenaForAllocation());
}
inline std::string* ScanRequest::release_key_start() {
  // @@protoc_insertion_point(field_release:kvstore.ScanRequest.key_start)
  return _impl_.key_start_.Release();
}
inline void ScanRequest::set_allocated_key_start(std::string* key_start) {
  if (key_start != nullptr) {
    
  } else {
    
  }
  _impl_.key_start_.SetAllocated(key_start, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.key_start_.IsDefault()) {
    _impl_.key_start_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:kvstore.ScanRequest.key_start)
}

// string key_end = 2;
inline void ScanRequest::clear_key_end() {
  _impl_.key_end_.ClearToEmpty();
}
inline const std::string& ScanRequest::key_end() const {
  // @@protoc_insertion_point(field_get:kvstore.ScanRequest.key_end)
  return _internal_key_end();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ScanRequest::set_key_end(ArgT0&& arg0, ArgT... args) {
 
 _impl_.key_end_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:kvstore.ScanRequest.key_end)
}
inline std::string* ScanRequest::mutable_key_end() {
  std::string* _s = _internal_mutable_key_end();
  // @@protoc_insertion_point(field_mutable:kvstore.ScanRequest.key_end)
  return _s;
}
inline const std::string& ScanRequest::_internal_key_end() const {
  return _impl_.key_end_.Get();
}
inline void ScanRequest::_internal_set_key_end(const std::string& value) {
  
  _impl_.key_end_.Set(value, GetArenaForAllocation());
}
inline std::string* ScanRequest::_internal_mutable_key_end() {
  
  return _impl_.key_end_.Mutable(GetArenaForAllocation());
}
inline std::string* ScanRequest::release_key_end() {
  // @@protoc_insertion_point(field_release:kvstore.ScanRequest.key_end)
  return _impl_.key_end_.Release();
}
inline void ScanRequest::set_allocated_key_end(std::string* key_end) {
  if (key_end != nullptr) {
    
  } else {
    
  }
  _impl_.key_end_.SetAllocated(key_end, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.key_end_.IsDefault()) {
    _impl_.key_end_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:kvstore.ScanRequest.key_end)
}
...
// repeated .kvstore.KvEntry entries = 1;
inline int ScanResponse::_internal_entries_size() const {
  return _impl_.entries_.size();
}
inline int ScanResponse::entries_size() const {
  return _internal_entries_size();
}
inline void ScanResponse::clear_entries() {
  _impl_.entries_.Clear();
}
inline ::kvstore::KvEntry* ScanResponse::mutable_entries(int index) {
  // @@protoc_insertion_point(field_mutable:kvstore.ScanResponse.entries)
  return _impl_.entries_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::kvstore::KvEntry >*
ScanResponse::mutable_entries() {
  // @@protoc_insertion_point(field_mutable_list:kvstore.ScanResponse.entries)
  return &_impl_.entries_;
}
inline const ::kvstore::KvEntry& ScanResponse::_internal_entries(int index) const {
  return _impl_.entries_.Get(index);
}
inline const ::kvstore::KvEntry& ScanResponse::entries(int index) const {
  // @@protoc_insertion_point(field_get:kvstore.ScanResponse.entries)
  return _internal_entries(index);
}
inline ::kvstore::KvEntry* ScanResponse::_internal_add_entries() {
  return _impl_.entries_.Add();
}
inline ::kvstore::KvEntry* ScanResponse::add_entries() {
  ::kvstore::KvEntry* _add = _internal_add_entries();
  // @@protoc_insertion_point(field_add:kvstore.ScanResponse.entries)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::kvstore::KvEntry >&
ScanResponse::entries() const {
  // @@protoc_insertion_point(field_list:kvstore.ScanResponse.entries)
  return _impl_.entries_;
}
...
inline const std::string& KvEntry::key() const {
  // @@protoc_insertion_point(field_get:kvstore.KvEntry.key)
  return _internal_key();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void KvEntry::set_key(ArgT0&& arg0, ArgT... args) {
 
 _impl_.key_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:kvstore.KvEntry.key)
}
inline std::string* KvEntry::mutable_key() {
  std::string* _s = _internal_mutable_key();
  // @@protoc_insertion_point(field_mutable:kvstore.KvEntry.key)
  return _s;
}
...
inline std::string* KvEntry::release_key() {
  // @@protoc_insertion_point(field_release:kvstore.KvEntry.key)
  return _impl_.key_.Release();
}
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:kvstore.KvEntry.key)
}
...
inline const std::string& KvEntry::value() const {
  // @@protoc_insertion_point(field_get:kvstore.KvEntry.value)
  return _internal_value();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void KvEntry::set_value(ArgT0&& arg0, ArgT... args) {
 
 _impl_.value_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:kvstore.KvEntry.value)
}
inline std::string* KvEntry::mutable_value() {
  std::string* _s = _internal_mutable_value();
  // @@protoc_insertion_point(field_mutable:kvstore.KvEntry.value)
  return _s;
}
...
inline std::string* KvEntry::release_value() {
  // @@protoc_insertion_point(field_release:kvstore.KvEntry.value)
  return _impl_.value_.Release();
}
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:kvstore.KvEntry.value)
}
