...
class KvStore final {
 public:
  ...
  typedef WithAsyncMethod_Put<WithAsyncMethod_Swap<WithAsyncMethod_Get<WithAsyncMethod_Scan<WithAsyncMethod_Delete<Service > > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_Put<WithCallbackMethod_Swap<WithCallbackMethod_Get<WithCallbackMethod_Scan<WithCallbackMethod_Delete<Service > > > > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_Put<WithStreamedUnaryMethod_Swap<WithStreamedUnaryMethod_Get<WithStreamedUnaryMethod_Scan<WithStreamedUnaryMethod_Delete<Service > > > > > StreamedUnaryService;
